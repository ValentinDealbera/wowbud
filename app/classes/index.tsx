...
export default function Classes() {
  ...
  return (
    ...
    alignItems: 'center',
    gap: 30}}>
            <Text style={{borderRadius: 10,backgroundColor: '#232323', paddingHorizontal: 10, paddingVertical:5 , fontSize: 28, color: '#fff', textAlign: 'center'}}>Classes</Text>
        </View>
    <View style={styles.container}>
        {
        classes.map((element, i)=>{
            return (
                <IndividualCard key={i} URL={`/classes/${element.URL}`} name={element.name} image={element.image} />
            )
        })}
    </View>
    </ScrollView>
